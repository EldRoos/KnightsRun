...
if attack_buffer>=attack_buffer_cap and flying=0{attack_buffer=0 instance_create_depth(x-sprite_width,y-sprite_height/3,depth-10,enemy_hit_medium).attack_damage=attack_damage} //Attack Non-flying
