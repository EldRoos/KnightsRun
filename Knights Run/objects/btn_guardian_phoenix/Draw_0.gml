...
draw_text2(x+7,y+23,"Level: "+calc_number(store.guardian_phoenix_lvl),c_yellow)
...
draw_rectangle_colour(x+5,y+(18+sprite_height/2),x+((store.phoenix_ready/store.phoenix_readytime)*313),y+(26+sprite_height/2),c_orange,c_yellow,c_orange,c_yellow,false)
}
