...
{
	if distance_to_object(instance_nearest(x,y,default_enemy))<80 and mode!="attack" {mode="battle"}
}
...
if attack_buffer>=60 {mode="attack" image_index=0 sprite_index=spr_player_attack attack_buffer=0}
}
