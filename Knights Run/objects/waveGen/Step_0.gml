// Genetix Studio
if waveWait = 1 and instance_number(default_enemy) <=0 and instance_number(enemy_death)<=0 and instance_number(item_guardiankey)<=0 and hud.game_over=0
{
waveWait = 0
hud.stage_complete=1
if store.bloodmoon>0 {store.bloodmoon-=1}
save_game()
