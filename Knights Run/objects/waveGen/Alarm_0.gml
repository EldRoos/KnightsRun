...
var spawnBat = 5 + tier +(3*store.active_lures)
...
//EVENTS ------------------------------------------------------
if store.current_stage=5 or store.current_stage%15==0 {
if 100>random(100) {instance_create_depth(random_range(520,560),y-12,-205,event_well)}
}
