...
var _text = calc_number(store.lifesteal_chance + hud.tmp_lifesteal_boost) + "%";
if hud.tmp_lifesteal_boost > 0
	draw_text2(x + 132, y + 11, _text, c_orange)
else
	draw_text2(x + 132, y + 11, _text, c_white)
if maxxed = 0 {
	draw_number(x + 152, y + 38, store.cost_lifesteal_chance, c_white)
